...
def train_gbt(minInstancesPerNode,maxDepth, maxIter,stepSize, maxBins):
  ...
  return model, validation_metric,  test_precision, test_recall, test_f2_score, validation_metric_train, train_precision, train_recall, train_f2_score, importance_list
...
def train_with_hyperopt(params):
    ...
    with mlflow.start_run(nested=True):
        ...
        model, validation_metric, test_precision, test_recall, test_f2_score, validation_metric_train, train_precision, train_recall, train_f2_score, importance_list = train_gbt(minInstancesPerNode, maxDepth, maxIter, stepSize, maxBins)
