...
# MAGIC %md
# MAGIC # PLEASE CLONE THIS NOTEBOOK INTO YOUR PERSONAL FOLDER and  DO NOT RUN CODE IN THE SHARED FOLDER
...
df_weather =  spark.read.parquet(f"{mids261_mount_path}/datasets_final_project/weather_data/*").filter(col('DATE') > "2019-01-01T00:00:00.000+00:00").cache()
display(df_weather)
